                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>";
                            echo "<td>" . htmlspecialchars($row['name']) . "</td>"; // htmlspecialchars to prevent XSS
                            echo "<td>" . htmlspecialchars($row['email']) . "</td>"; // htmlspecialchars to prevent XSS
                            echo "<td><a href='view_classes_admin.php?id={$row['id']}' class='btn btn-primary btn-sm'>Manage</a></td>";
                            echo "</tr>";
                        }
                    } else {
